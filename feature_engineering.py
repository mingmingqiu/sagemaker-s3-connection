...
# Input and output directories provided by SageMaker
input_path = "/opt/ml/processing/input/bank-additional-full.csv"
output_path = "/opt/ml/processing/output/bank_additional_transformed.csv"
...
# Save to SageMaker output directory (SageMaker uploads automatically)
...
#     # df['balance_log'] = np.log(df['nr.employed'] + 1)
